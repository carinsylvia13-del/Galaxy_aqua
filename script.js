const products = [
  ...
  ['Mitty Stainless 3-Tap Cooler','dispensers','A durable stainless-steel dispenser designed for convenient multi-user drinking-water access.','160f4d66-acdb-4c53-8f9e-73bd7f71c9b4.JPG'],
  ['Mitty Twin-Tap Water Dispenser','dispensers','A floor-standing drinking-water dispenser with two taps for busy shared spaces.','1b749f96-4e1b-4849-877c-89b4c3b9cdaa.JPG'],
  ...
  ['Mitty Climate+ Dispenser','dispensers','A compact countertop dispenser offering convenient hot and cold drinking-water service.','235fcd52-d6d3-4e66-b3eb-dfc37625aecb.JPG'],
  ...
  ['Mitty Floor-Standing Cooler','dispensers','A stainless-steel drinking-water cooler built for simple, reliable everyday dispensing.','3072fa2c-ee80-48ac-a67a-e17a97e27bdb.JPG'],
  ['Compact Hot-Water Unit','dispensers','A space-saving wall-mounted unit for readily available treated hot water.','30ff9236-cc56-48cc-87ea-1467acf9a1ad.JPG'],
  ...
  ['Ruzo Alkaline Cartridge','components','A post-treatment cartridge designed to condition taste and add an alkaline finishing stage.','3ed83e2c-46c0-400e-ba9c-127fe6a317f7.JPG'],
  ...
  ['Mitty Mini RO-ST','purifiers','A compact RO system package created for everyday domestic drinking-water purification.','4287e7c6-e383-4325-8238-464af3596652.JPG'],
  ...
  ['Mitty Nano RO','purifiers','A compact domestic RO purifier package suited to kitchens with limited installation space.','50d646ab-7a5b-4898-b536-38f66973c00b.JPG'],
  ...
  ['PGM Stainless Purifier','commercial','A stainless commercial purifier for supplying treated drinking water in higher-demand settings.','5cb49ded-e2fb-472c-bffa-da6d7870ba48.JPG'],
  ['PGM Drinking-Water Station','commercial','A high-capacity stainless drinking station with multiple dispensing points for shared facilities.','7c2d8276-fbfd-417d-9d48-b045cbb5bba9.JPG'],
  ['Mitty Wonder RO','purifiers','A feature-rich domestic RO purifier package for convenient everyday drinking-water treatment.','a133fd67-dbce-4b31-8637-88356399bf45.JPG'],
  ['Compact Commercial RO Plant','commercial','An open-frame RO treatment plant that makes service access straightforward for commercial use.','a134e12e-9807-47fb-abf5-60576c6e1564.JPG'],
  ['Mitty 250 LPH RO Plant','commercial','A packaged reverse-osmosis plant designed for higher-volume treated-water production.','b0869941-68fd-4587-b9eb-f63a0a33903f.JPG'],
  ...
  ['Mitty Portable DM Plant','commercial','A compact demineralisation unit for applications that need lower-mineral process water.','db9ebf4c-2c4e-4446-a338-d823b8a177ce.JPG'],
